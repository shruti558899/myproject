    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6 col-md-4 col-xl-2 px-0">
          <a href="#" class="box">
            <div class="img-box">
              <img src="{{url('frontend/images/c1.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Web Design
        ...
        <div class="col-sm-6 col-md-4 col-xl-2 px-0">
          <a href="#" class="box">
            <div class="img-box">
              <img src="{{url('frontend/images/c2.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Web Development
        ...
        <div class="col-sm-6 col-md-4 col-xl-2 px-0">
          <a href="#" class="box">
            <div class="img-box">
              <img src="{{url('frontend/images/c3.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Graphic Design
        ...
        <div class="col-sm-6 col-md-4 col-xl-2 px-0">
          <a href="#" class="box">
            <div class="img-box">
              <img src="{{url('frontend/images/c4.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Seo marketing
        ...
        <div class="col-sm-6 col-md-4 col-xl-2 px-0">
          <a href="#" class="box">
            <div class="img-box">
              <img src="{{url('frontend/images/c5.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Accounting
        ...
        <div class="col-sm-6 col-md-4 col-xl-2 px-0">
          <a href="#" class="box">
            <div class="img-box">
              <img src="{{url('frontend/images/c6.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Content Writing
          ...
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('frontend/images/job_logo1.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('frontend/images/job_logo3.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
          ...
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('frontend/images/job_logo6.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
          ...
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('frontend/images/job_logo5.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
          ...
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('frontend/images/job_logo4.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{url('frontend/images/e1.jpg')}}" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Martin Anderson
        ...
        <div class="col-md-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{url('frontend/images/e2.jpg')}}" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Semanta Klores
        ...
        <div class="col-md-6 col-lg-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{url('frontend/images/e3.jpg')}}" alt="">
            </div>
            <div class="detail-box">
              <a href="">
                Ryan Martines
      ...
      <div class="row">
        <div class="col-md-2 info_links">
          ...
          <ul>
            ...
            <li>
              <a class="" href="{{url('/job')}}">
                Jobs
              </a>
            </li>
            <li>
              <a class="" href="{{url('/freelancer')}}">
                Freelancers
              </a>
            </li>
          </ul>
