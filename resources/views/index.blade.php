        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('images/job_logo1.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
          ...
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('images/job_logo2.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('images/job_logo3.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
          ...
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('images/job_logo6.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
          ...
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('images/job_logo5.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
          ...
          <div class="col-lg-6">
            <div class="box">
              <div class="job_content-box">
                <div class="img-box">
                  <img src="{{url('images/job_logo4.png')}}" alt="">
                </div>
                <div class="detail-box">
                  <h5>
